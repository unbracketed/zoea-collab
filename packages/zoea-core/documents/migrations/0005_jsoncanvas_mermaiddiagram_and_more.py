...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RenameIndex(
            model_name='folder',
            new_name='documents_f_workspa_2d201f_idx',
            old_name='documents_f_workspa_0d54ac_idx',
        ),
        ...
        migrations.AlterField(
            model_name='folder',
            name='workspace',
            field=models.ForeignKey(help_text='Workspace that owns this folder', on_delete=django.db.models.deletion.CASCADE, related_name='folders', to='workspaces.workspace'),
        ),
        migrations.AlterField(
