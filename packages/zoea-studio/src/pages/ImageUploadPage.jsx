...
function ImageUploadPage() {
  ...
  return (
    <LayoutFrame title="Upload Image" variant="content-centered">
      <div className="max-w-4xl mx-auto py-4 px-4">
        <div className="mb-6">
          <h1 className="text-2xl font-bold">Upload Image Document</h1>
          <p className="text-text-secondary">Convert an image into a document for further processing.</p>
        </div>
