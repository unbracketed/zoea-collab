...
function PDFUploadPage() {
  ...
  const handleUpload = async () => {
    if (!file) {
      setStatus('Please select a PDF to upload.')
      return
    }
  ...
  return (
    <LayoutFrame title="Upload PDF" variant="content-centered">
      <div className="max-w-4xl mx-auto py-4 px-4">
        <div className="mb-6">
          <h1 className="text-2xl font-bold">Upload PDF Document</h1>
          <p className="text-text-secondary">Upload a PDF document for viewing and text extraction.</p>
        </div>
